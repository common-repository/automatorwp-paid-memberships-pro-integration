...
class AutomatorWP_Paid_Memberships_Pro_Cancel_Subscription extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User cancels a subscription of a membership level', 'automatorwp-paid-memberships-pro' ),
            'select_option'     => __( 'User <strong>cancels a subscription</strong> of a membership level', 'automatorwp-paid-memberships-pro' ),
            /* translators: %1$s: Content title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User cancels a subscription of %1$s %2$s time(s)', 'automatorwp-paid-memberships-pro' ), '{membership}', '{times}' ),
            /* translators: %1$s: Content title. */
            'log_label'         => sprintf( __( 'User cancels a subscription of %1$s', 'automatorwp-paid-memberships-pro' ), '{membership}' ),
